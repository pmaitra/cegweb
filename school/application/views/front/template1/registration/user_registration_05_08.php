                    ...
                    <form class="" id="user-registraiton-frm"  enctype="multipart/form-data" action="<?php //echo BASEURL;?>usersubmission" method="post" role="form">
                        ...
                        <div class="row">
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input name="date_of_birth" id="date_of_birth" type="text" data-plugin-datepicker="" data-date-format="dd/mm/yyyy" value="<?php echo (!empty($candidate_details['date_of_birth']))?$candidate_details['date_of_birth']:''; ?>" class="form-control preview_input datepicker">
                            </div>
                          </div>
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <div style="" class="form-group">
                                <label class="radio-inline radio-primary preview_input">
                                  <input type="radio" class="preview_radio" data-previewid="gender_data" required="required" value="Male" id="male"
                                    name="sex_is" <?php echo set_radio('sex_is', 'Male'); ?> >
                                  Male </label>
                                <label class="radio-inline radio-primary preview_input padding-right-30">
                                  <input type="radio" class="preview_radio" required="required" data-previewid="gender_data" value="Female" id="female" name="sex_is" <?php echo set_radio('sex_is', 'Female'); ?> >
                                  Female </label>
                              </div>
                            </div>
                          </div>
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <div style="margin-top: 5px;" class="form-group">
                                <label class="radio-inline radio-primary preview_input">
                                  <input type="radio" value="Single" required="required" class="preview_radio" data-previewid="marital_status_data" id="single" name="marital_status_is" <?php echo set_radio('marital_status_is', 'single'); ?>>
                                  Single </label>
                                <label class="radio-inline radio-primary preview_input padding-right-30">
                                  <input type="radio" required="required" value="Married" class="preview_radio" data-previewid="marital_status_data" id="married" name="marital_status_is" <?php echo set_radio('marital_status_is', 'married'); ?>>
                                  Married </label>
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="panel-footer">
                        <ul class="pager">
                          ...
                          <li class="next">
                            <button class="btn btn-xs pull-right" id="btn_submit_personal_details" type="">
                ...
                <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control preview_input" id="group_major_hsc" name="group_major_hsc" value="<?php echo (!empty($single_qualification['degree']))?$single_qualification['degree']:''; //echo (!empty(set_value('group_major_hsc')))?set_value('group_major_hsc'):$single_qualification['specialization']; ?>">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
            ...
            ?>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              <label class="control-label">Year of Passing <span class="required" aria-required="true">*</span></label>
                              <input  id="year_of_passing_ssc" name="year_of_passing_ssc" data-plugin-datepicker="" value="<?php echo (!empty($candidate_details['year_of_passing_ssc']))?$candidate_details['year_of_passing_ssc']:''; ?>" placeholder="____" class="form-control valid preview_input datepicker">
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group">
                              <label class="control-label">Group / Major <span class="required" aria-required="true">*</span></label>
                              <input type="text" class="form-control preview_input" id="group_major_hsc" name="group_major_hsc" value="<?php echo (!empty($candidate_details['group_major_hsc']))?$candidate_details['group_major_hsc']:''; ?>">
                            </div>
                          </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              <label class="control-label">Year of Passing <span class="required" aria-required="true">*</span></label>
                              <input data-input-mask="9999" id="year_of_passing_hsc" data-plugin-datepicker="" name="year_of_passing_hsc" value="<?php echo (!empty($candidate_details['year_of_passing_hsc']))?$candidate_details['year_of_passing_hsc']:''; ?>" placeholder="____" class="form-control valid preview_input datepicker" >
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                          ...
                          <div id="passed_data_ug" class="hide">
                            <div id="passed_data_pg_year" class="">
                              <div class="col-md-3">
                                <div class="form-group">
                                  <label class="control-label">Year of Passing <span class="required" aria-required="true">*</span></label>
                                  <input id="year_of_passing_ug"  data-input-mask="9999" name="year_of_passing_ug" data-plugin-datepicker="" value="<?php echo (!empty($candidate_details['year_of_passing_ug']))?$candidate_details['year_of_passing_ug']:''; ?>" placeholder="____" class="form-control valid preview_input datepicker">
                                </div>
                              </div>
                            </div>
                            <div id="passed_data_ug_percentage" class="">
                          ...
                          <div id="passed_data_pg" class="hide">
                            <div id="passed_data_pg_year" class="">
                              <div class="col-md-3">
                                <div class="form-group">
                                  <label class="control-label">Year of Passing</label>
                                  <input id="year_of_passing_pg"  data-plugin-datepicker="" data-input-mask="9999" name="year_of_passing_pg" value="<?php echo (!empty($candidate_details['year_of_passing_pg']))?$candidate_details['year_of_passing_pg']:''; ?>" placeholder="____" class="form-control valid preview_input datepicker" >
                                </div>
                              </div>
                            </div>
                            <div id="passed_data_pg_percentage" class="">
              ...
              <?php } ?>
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            ...
                            <textarea class="form-control preview_input" rows="3" id="academic_achievement" name="academic_achievement" value="<?php echo (!empty($candidate_details['academic_or_cocurricular_achievements']))?$candidate_details['academic_or_cocurricular_achievements']:''; ?>" ></textarea>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-md-12">
                      ...
                      <div class="panel-footer">
                        <ul class="pager">
                          ...
                          <li class="next">
                            <button class="btn btn-xs" id="btn_submit_accademic_details" type="" id="">
                            Next <i class="fa fa-angle-right"></i>
                            </button>
                  ...
                  <div class="tab-pane" role="tabpanel" id="professional_experience">
                      ...
                      <div id="professional-experience" class="tab-pane">
                          ...
                          <div class="col-md-2">
                            <div class="form-group">
                              ...
                              <input type="text"  class="form-control preview_input datepicker" id="start_from_1" name="start_from_1" data-plugin-datepicker="" value="<?php echo (!empty($single_professional_experience['start_from']))?$single_professional_experience['start_from']:''; ?>"
                               data-input-mask="99/99/9999" placeholder="__/__/____" class="form-control valid" >
                            </div>
                          </div>
                          <div class="col-md-2">
                            <div class="form-group">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-2">
                            <div class="form-group">
                              <label class="control-label">From </label>
                              <input type="text"  class="form-control preview_input datepicker" id="start_from_1" name="start_from_1" data-plugin-datepicker="" value="<?php echo set_value('start_from_1'); ?>"
                               data-input-mask="99/99/9999" placeholder="__/__/____" class="form-control valid" >
                            </div>
                          </div>
                          <div class="col-md-2">
                            <div class="form-group">
                              <label class="control-label">To</label>
                              <input type="text"  class="form-control preview_input datepicker" id="start_to_1" name="start_to_1" data-plugin-datepicker="" value="<?php echo set_value('start_to_1'); ?>" 
                               data-input-mask="99/99/9999" placeholder="__/__/____" class="form-control valid"  >
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-2">
                            <div class="form-group">
                              <input type="text"  class="form-control preview_input datepicker" id="start_from_2" name="start_from_2" data-plugin-datepicker="" value="<?php echo set_value('start_from_2'); ?>" data-input-mask="99/99/9999" placeholder="__/__/____" class="form-control valid" >
                            </div>
                          </div>
                          <div class="col-md-2">
                            <div class="form-group">
                              <input type="text"  class="form-control preview_input datepicker" id="start_to_2" name="start_to_2" data-plugin-datepicker="" value="<?php echo set_value('start_to_2'); ?>" data-input-mask="99/99/9999" placeholder="__/__/____" class="form-control valid"  >
                            </div>
                          </div>
                        </div>
                        <br/>
                        <div class="row">
                          ...
                          <div class="col-md-2">
                            <div class="form-group">
                              <input type="text"  class="form-control preview_input datepicker" id="start_from_3" name="start_from_3" data-plugin-datepicker="" value="<?php echo set_value('start_from_3'); ?>" data-input-mask="99/99/9999" placeholder="__/__/____" class="form-control valid" >
                            </div>
                          </div>
                          <div class="col-md-2">
                            <div class="form-group">
                              <input type="text"  class="form-control preview_input datepicker" id="start_to_3" name="start_to_3" data-plugin-datepicker="" value="<?php echo set_value('start_to_3'); ?>" data-input-mask="99/99/9999" placeholder="__/__/____" class="form-control valid"  >
                            </div>
                          </div>
                        </div>
                        <?php } ?>
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="organization_2" value="<?php echo set_value('organization_2'); ?>" placeholder="Organization Name">
                        <br>
                        <input type="text" class="form-control" name="organization_3" value="<?php echo set_value('organization_3'); ?>" placeholder="Organization Name">
                        <br>
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group">
                        <label class="control-label"> Designation </label>
                        <input type="text" class="form-control" name="designation_1" value="<?php echo set_value('designation_1'); ?>" placeholder="Designation">
                        <br>
                        <input type="text" class="form-control" name="designation_2" value="<?php echo set_value('designation_2'); ?>" placeholder="Designation">
                        <br>
                        <input type="text" class="form-control" name="designation_3" value="<?php echo set_value('designation_3'); ?>" placeholder="Designation">
                        <br>
                      </div>
                    </div>
                    <div class="col-md-2">
                      <div class="form-group">
                        <label class="control-label">Roles</label>
                        <input type="text" class="form-control" name="roles_1" value="<?php echo set_value('roles_1'); ?>" placeholder="Roles">
                        <br>
                        <input type="text" class="form-control" name="roles_2" value="<?php echo set_value('roles_2'); ?>" placeholder="Roles">
                        <br>
                        <input type="text" class="form-control" name="roles_3" value="<?php echo set_value('roles_3'); ?>" placeholder="Roles">
                        <br>
                      </div>
                    </div>
                    <div class="col-md-2">
                      <div class="form-group">
                        <label class="control-label">From </label>
                        <input type="text" data-plugin-masked-input="" class="form-control" name="start_from_1" value="<?php echo set_value('start_from_1'); ?>"
                               data-input-mask="99/99/9999" placeholder="__/__/____" class="form-control valid" aria-invalid="false">
                        <br>
                        <input type="text" data-plugin-masked-input="" class="form-control" name="start_from_2" value="<?php echo set_value('start_from_2'); ?>" 
                               data-input-mask="99/99/9999" placeholder="__/__/____" class="form-control valid" aria-invalid="false">
                        <br>
                        <input type="text" data-plugin-masked-input="" class="form-control" name="start_from_3" value="<?php echo set_value('start_from_3'); ?>" 
                               data-input-mask="99/99/9999" placeholder="__/__/____" class="form-control valid" aria-invalid="false">
                        <br>
                      </div>
                      <br>
                    ...
                    <div class="col-md-2">
                      <div class="form-group">
                        <label class="control-label">To</label>
                        <input type="text" data-plugin-masked-input="" class="form-control" name="start_to_1" value="<?php echo set_value('start_to_1'); ?>" 
                               data-input-mask="99/99/9999" placeholder="__/__/____" class="form-control valid" aria-invalid="false" >
                        <br>
                        <input type="text" data-plugin-masked-input="" class="form-control" name="start_to_2" value="<?php echo set_value('start_to_2'); ?>"
                               data-input-mask="99/99/9999" placeholder="__/__/____" class="form-control valid" aria-invalid="false" >
                        <br>
                        <input type="text" data-plugin-masked-input="" class="form-control" name="start_to_3" value="<?php echo set_value('start_to_3'); ?>" 
                               data-input-mask="99/99/9999" placeholder="__/__/____" class="form-control valid" aria-invalid="false">
                        <br>
                      </div>
                    </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-12">
                            ...
                            <textarea class="form-control preview_input" rows="3"  id="professional_achievements" name="professional_achievements" value="<?php echo (!empty($single_qualification['affiliation']))?$single_qualification['affiliation']:''; ?>" ></textarea>
                          </div>
                        </div>
                      </div>
                      <div class="panel-footer">
                        <ul class="pager">
                          ...
                          <li class="next">
                            <button class="btn  btn-xs" id="btn_submit_professional_experience">
                            Next <i class="fa fa-angle-right"></i>
                            </button>
                            ...
                            <div class="panel-body">
                              ...
                              <table class="table table-striped">
                                ...
                                <tr>
                                  ...
                                  <td><div id="date_of_birth_data" > <?php echo (!empty($candidate_details['date_of_birth']))?$candidate_details['date_of_birth']:'';?> </div></td>
                                </tr>
                                <tr>
                                  <td><b>Sex</b></td>
                            ...
                            foreach ($qualification_details as $single_qualification) {
                              ...
                              <table class="table table-striped">
                                ...
                                <tr>
                                  ...
                                  <td><div id="year_of_passing_ssc_data" > <?php  echo (!empty($single_qualification['end_date']))?$single_qualification['end_date']:''; ?> </div></td>
                              ...
                              <table class="table table-striped">
                                ...
                                <tr>
                                  <td colspan="4"><div id="group_major_hsc_data" > <?php echo (!empty($single_qualification['degree']))?$single_qualification['degree']:'';?> </div></td>
                                </tr>
                                <tr>
                                  <td><b>Name of the School</b></td>
                                  <td><b>Name of the Board</b></td>
                                ...
                                <tr>
                                  ...
                                  <td><div id="year_of_passing_hsc_data" > <?php echo (!empty($single_qualification['end_date']))?$single_qualification['end_date']:''; ?> </div></td>
                              ...
                              <table class="table table-striped">
                                ...
                                <tr>
                                  ...
                                  <td><?php echo (!empty($single_qualification['end_date']))?$single_qualification['end_date']:''; ?></td>
                             ...
                             ?>
                              ...
                              <table class="table table-striped">
                                ...
                                <tr>
                                  ...
                                  <td><div id="year_of_passing_ug_data" > <?php echo (!empty($single_qualification['end_date']))?$single_qualification['end_date']:'';?> </div></td>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                   <div class="radio-custom radio-primary">
                                      <input type="radio" id="radio1" name="radioExample1">
                    ...
                    <div class="modal fade" id="at-coupon" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                        ...
                        <div class="modal-content">
                          <div class="modal-header">
                            <h2>Coupon <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">Ã—</span></button></h2>
                      ...
                      <div class="panel-footer">
                        <ul class="pager">
                          ...
                          <li class="next">
                            <button class="btn btn-xs" id="next_payment_declaration">Next <i class="fa fa-angle-right"></i></button>
                          </li>
                        </ul>
                      </div>
                    </form>
