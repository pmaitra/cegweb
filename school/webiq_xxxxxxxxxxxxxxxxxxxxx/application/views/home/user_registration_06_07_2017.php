              ...
              <div class="wizard">
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane" role="tabpanel" id="personal_details">
                    ...
                    ?>
                      <button id="<?php echo $survey_display_arr[2][$i]['combination_id'] ;?>" class="btn btn-primary survey_btn" data-toggle="modal" data-target="#survey_modal"><?php echo $survey_display_arr[2][$i]['combination_link'] ;?></button>
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                <button id="survey_submit_btn" data-id="" class="btn btn-success">Submit </button>
                              </div>
                            </div>
                          </div>
                        </div>
                  ...
                  <div class="tab-pane" role="tabpanel" id="academic_qualification">
                    ...
                    ?>
                      <button id="<?php echo $survey_display_arr[3][$i]['combination_id'] ;?>" class="btn btn-primary survey_btn" data-toggle="modal" data-target="#survey_modal"><?php echo $survey_display_arr[3][$i]['combination_link'] ;?></button>
                      <section class="at-login-form">
                        <!-- MODAL survey -->
                        <div class="modal fade" id="survey_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                <button id="survey_submit_btn" data-question="" class="btn btn-success">Submit </button>
                              </div>
                            </div>
                          </div>
                        </div>
                  ...
                  <div class="tab-pane" role="tabpanel" id="professional_experience">
                    <form id="prof-experience-update-frm" action="#" method="post" role="form">
                      <div id="professional-experience" class="tab-pane">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-2">
                            <div class="form-group">
                              <input type="text"  class="form-control preview_input datepicker" id="start_from_2" readonly="readonly" name="start_from_2" value="<?php echo set_value('start_from_2'); ?>"
                                placeholder="__/__/____" data-plugin-datepicker="" >
                            </div>
                          </div>
                          <div class="col-md-2">
                            <div class="form-group">
                              <input type="text"  class="form-control preview_input datepicker" id="start_to_2" readonly="readonly" name="start_to_2" value="<?php echo set_value('start_to_2'); ?>" 
                               placeholder="__/__/____" data-plugin-datepicker="" >
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-2">
                            <div class="form-group">
                              <input type="text"  class="form-control preview_input datepicker" id="start_from_3" readonly="readonly" name="start_from_3" value="<?php echo set_value('start_from_3'); ?>"
                                placeholder="__/__/____" data-plugin-datepicker="" >
                            </div>
                          </div>
                          <div class="col-md-2">
                            <div class="form-group">
                              <input type="text"  class="form-control preview_input datepicker" id="start_to_3" readonly="readonly" name="start_to_3" value="<?php echo set_value('start_to_3'); ?>" 
                               placeholder="__/__/____" data-plugin-datepicker="" >
                            </div>
                          </div>
                        </div>
                      ...
                      <?php if(!empty($survey_display_arr[4]))
                    {
                      for($i=0 ; $i < count($survey_display_arr[4]) ; $i++)
                      {
                         //pr($survey_display_arr[1][$i]);
                    ?>
                      <button id="<?php echo $survey_display_arr[4][$i]['combination_id'] ;?>" class="btn btn-primary survey_btn" data-toggle="modal" data-target="#survey_modal"><?php echo $survey_display_arr[4][$i]['combination_link'] ;?></button>
                      <section class="at-login-form">
                        <!-- MODAL survey -->
                        <div class="modal fade" id="survey_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                <button id="survey_submit_btn" class="btn btn-success">Submit </button>
                              </div>
                            </div>
                          </div>
                        </div>
                  ...
                  <div class="tab-pane" role="tabpanel" id="verify_statement">
                      ...
                      <?php if(!empty($survey_display_arr[5]))
                    {
                      for($i=0 ; $i < count($survey_display_arr[5]) ; $i++)
                      {
                         //pr($survey_display_arr[1][$i]);
                    ?>
                      <button id="<?php echo $survey_display_arr[5][$i]['combination_id'] ;?>" class="btn btn-primary survey_btn" data-toggle="modal" data-target="#survey_modal"><?php echo $survey_display_arr[5][$i]['combination_link'] ;?></button>
                      <section class="at-login-form">
                        <!-- MODAL survey -->
                        <div class="modal fade" id="survey_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                          <div class="modal-dialog" role="document">
