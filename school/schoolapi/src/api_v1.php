...
$app->get('/v1/check', function ($request, $response, $args) use($app) {
    return createResponse($response,200,1,"Welcome to SSP API verson 1.0");
})->setName('check');
    ...
    try 
    {
        ...
        'formId','rollNumber','dateOfBirth','admissisonDate','gender','bloodGroup','category',
          'nationality','fatherFirstName','guardianFirstName','guardianLastName',
                    'address','courseCode','academicsSession'));
       ...
       print_r($e);die;// error_log(var_export($e,1));
...
$app->post('/v1/updateBasicDetailsOfCadet', function ($request, $response, $args) {
     try 
    {
        ...
        if(!empty($studentDetails->id))
        {
            ...
            {
                $studentDetails->email = $requestParams['email'];
            }
            if(!empty($requestParams['dateOfBirth']))
            {
                $studentDetails->dateOfBirth = convertDateTimeSting($requestParams['dateOfBirth'],'date');
                //@todo update in user
            }
            if(!empty($requestParams['admissisonDate']))
            {
                $studentDetails->admissisonDate = convertDateTimeSting($requestParams['admissisonDate'],'date');
            }
            ...
            {
                $studentDetails->contactNumber = trim($requestParams['contactNumber']);
            }
		...
		if(!empty($requestParams['fatherFirstName']))
            ...
            if(!empty($requestParams['fatherMobile']))
            {
                $studentDetails->fatherMobile = trim($requestParams['fatherMobile']);
            }
            if(!empty($requestParams['fatherEmail']))
            {
                $studentDetails->fatherEmail = trim($requestParams['fatherEmail']);
            }
            if(!empty($requestParams['fatherIncome']))
            {
                $studentDetails->fatherIncome = trim($requestParams['fatherIncome']);
            }	
            if(!empty($requestParams['fatherRank']))
            {
                $studentDetails->fatherRank = trim($requestParams['fatherRank']);
            }
            if(!empty($requestParams['fatherDefenceCategory']))
            {
                $studentDetails->fatherDefenceCategory = trim($requestParams['fatherDefenceCategory']);
            }
            
            if(!empty($requestParams['motherEmail']))
            {
                $studentDetails->motherEmail = trim($requestParams['motherEmail']);
            }
            if(!empty($requestParams['motherMiddleName']))
            {
                $studentDetails->motherMiddleName = trim($requestParams['motherMiddleName']);
            }
            if(!empty($requestParams['motherFirstName']))
            {
                $studentDetails->motherFirstName = trim($requestParams['motherFirstName']);
            }
            if(!empty($requestParams['motherLastName']))
            {
                $studentDetails->motherLastName = trim($requestParams['motherLastName']);
            }
            if(!empty($requestParams['motherIncome']))
            {
                $studentDetails->motherIncome = trim($requestParams['motherIncome']);
            }
            
             if(!empty($requestParams['guardianFirstName']))
            {
                $studentDetails->guardianFirstName = trim($requestParams['guardianFirstName']);
            }
            if(!empty($requestParams['guardianMiddleName']))
            {
                $studentDetails->guardianMiddleName = trim($requestParams['guardianMiddleName']);
            }
             if(!empty($requestParams['guardianLastName']))
            {
                $studentDetails->guardianLastName = trim($requestParams['guardianLastName']);
            }
             if(!empty($requestParams['guardianMobile']))
            {
                $studentDetails->guardianMobile = trim($requestParams['guardianMobile']);
            }
            if(!empty($requestParams['guardianEmail']))
            {
                $studentDetails->guardianEmail = trim($requestParams['guardianEmail']);
            }
            
            if(!empty($requestParams['familyIncome']))
            {
                $studentDetails->familyIncome = trim($requestParams['familyIncome']);
            }
            if(!empty($requestParams['studentIncome']))
            {
                $studentDetails->studentIncome = trim($requestParams['studentIncome']);
            }
            ...
            if(!empty($requestParams['previousSchoolAddress']))
            {
                $studentDetails->previousSchoolAddress = trim($requestParams['previousSchoolAddress']);
            }
            if(!empty($requestParams['previousSchoolEmail']))
            {
                $studentDetails->previousSchoolEmail = trim($requestParams['previousSchoolEmail']);
            }
            if(!empty($requestParams['previousSchoolPhone']))
            {
                $studentDetails->previousSchoolPhone = trim($requestParams['previousSchoolPhone']);
            }if(!empty($requestParams['fatherFirstName']))
            {
                $studentDetails->fatherFirstName = trim($requestParams['fatherFirstName']);
            }
            ...
            if(!empty($requestParams['previousSchoolName']))
            {
                $studentDetails->previousSchoolName = trim($requestParams['previousSchoolName']);
            }
            if(!empty($requestParams['previousSchoolWebsite']))
            {
                $studentDetails->previousSchoolWebsite = trim($requestParams['previousSchoolWebsite']);
            }
