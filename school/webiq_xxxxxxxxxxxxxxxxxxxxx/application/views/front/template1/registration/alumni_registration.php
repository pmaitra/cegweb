...
?>
    ...
    <section role="main" class="content-body">
      <header class="page-header">
        <h2>Registration : <?php echo (!empty($course_name))?$course_name:''; ?></h2>
      </header>
              ...
              <div class="wizard">
                <div class="wizard-inner">
                  ...
                  <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li role="presentation" class="disabled" id="tab_payment_declaration"> <a data-toggle="tab" aria-controls="complete" role="tab" title="Payment & Declaration"> <span class="round-tab">6</span>
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane" role="tabpanel" id="personal_details">
                    <form class="" id="user-registraiton-frm"  enctype="multipart/form-data" action="<?php //echo BASEURL;?>usersubmission" method="post" role="form">
                        ...
                        <div class="row">
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control preview_input" value="<?php echo (!empty($alumni_candidate_details['first_name']))?$alumni_candidate_details['first_name']:''; ?>" id="first_name" name="first_name" placeholder="First Name">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control preview_input" id="middle_name" name="middle_name" value="<?php echo (!empty($alumni_candidate_details['middle_name']))?$alumni_candidate_details['middle_name']:''; ?>" placeholder="Middle Name">
                            </div>
                          </div>
                          <div class="col-md-4">
                            <div class="form-group">
                              <label class="control-label">Last Name <span class="required" aria-required="true">*</span></label>
                              <input type="text" class="form-control preview_input" id="last_name" name="last_name" value="<?php echo (!empty($alumni_candidate_details['last_name']))?$alumni_candidate_details['last_name']:''; ?>" placeholder="Last Name">
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input name="date_of_birth" id="date_of_birth" type="text"  data-date-end-date="-2d" data-plugin-datepicker="" data-date-format="dd/mm/yyyy" value="<?php echo (!empty($alumni_candidate_details['date_of_birth']))?date('d/m/Y',strtotime($alumni_candidate_details['date_of_birth'])):''; ?>" readonly="readonly" class="form-control preview_input datepicker">
                            </div>
                          </div>
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <div style="" class="form-group">
                                <label class="radio-inline radio-primary preview_input">
                                  <input type="radio" class="preview_radio" data-previewid="gender_data" required="required" value="Male" id="male"
                                    name="sex_is" <?php echo (!empty($alumni_candidate_details['sex']) && ($alumni_candidate_details['sex'] == "Male") ? 'checked="checked"': ''); ?> >
                                  Male </label>
                                <label class="radio-inline radio-primary preview_input padding-right-30">
                                  <input type="radio" class="preview_radio" required="required" data-previewid="gender_data" value="Female" id="female" name="sex_is" 
                                      <?php echo (!empty($alumni_candidate_details['sex']) && ($alumni_candidate_details['sex'] == "Female") ? 'checked="checked"': ''); ?> >
                                  Female </label>
                              </div>
                            </div>
                          </div>
                              ...
                              <div style="margin-top: 5px;" class="form-group">
                                <label class="radio-inline radio-primary preview_input">
                                  <input type="radio" value="Single" required="required" class="preview_radio" data-previewid="marital_status_data" id="single" name="marital_status_is"
                                          <?php echo (!empty($alumni_candidate_details['marrital_status']) && ($alumni_candidate_details['marrital_status'] == "Single") ? 'checked="checked"': ''); ?>>
                                  Single </label>
                                <label class="radio-inline radio-primary preview_input padding-right-30">
                                  <input type="radio" required="required" value="Married" class="preview_radio" data-previewid="marital_status_data" id="married" name="marital_status_is"
                                         <?php echo (!empty($alumni_candidate_details['marrital_status']) && ($alumni_candidate_details['marrital_status']) == "Married" ? 'checked="checked"': ''); ?>>
                                  Married </label>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input class="form-control preview_input" name="contact_no" value="<?php echo (!empty($alumni_candidate_details['contact_number']))?$alumni_candidate_details['contact_number']:''; ?>" placeholder="(00) 00000-00000" data-input-mask="(99) 99999-99999"  id="phone">
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              <label class="control-label">E-Mail <span class="required" aria-required="true">*</span></label>
                              <input type="email" placeholder="eg.: examples@email.com" class="form-control preview_input" id="email" name="email" value="<?php echo (!empty($alumni_candidate_details['email_id']))?$alumni_candidate_details['email_id']:''; ?>" >
                            </div>
                          </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            ...
                            <?php if(!empty($venue_list)){
                              ?>    
                                <label class="control-label"> Interview Preferred Location <span class="required" aria-required="true">*</span></label>
                                <select id="interview_preffered_location" name="venue" class="form-control preview_select" data-previewid="country_data">
                                  <option id="" value="0" >Select</option>
                                    <?php foreach ($venue_list as $single_venue) { 
                                        if($single_venue['id'] == $alumni_candidate_details['interview_preffered_location'] )
                                        {
                                            $select_location_txt = "selected='selected'";
                                        }
                                        else 
                                        {
                                            $select_location_txt = "";
                                        ...
                                        ?>
                                      <option id="<?php echo $single_venue['id'] ?>" <?php echo $select_location_txt;?> value="<?php echo $single_venue['id'] ?>" ><?php  echo $single_venue['city'] ?></option>
                                    <?php } ?>
                                </select>   
                            <?php  }  else {  ?>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text"  class="form-control preview_input" id="pan_card_no" name="pan_card_no" value="<?php echo (!empty($alumni_candidate_details['pan_card_no']))?$alumni_candidate_details['pan_card_no']:''; ?>" placeholder="">
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text"  class="form-control preview_input" id="adhar_card_no" name="adhar_card_no" value="<?php echo (!empty($alumni_candidate_details['adhar_card_no']))?$alumni_candidate_details['adhar_card_no']:''; ?>" placeholder="">
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text"  class="form-control preview_input" id="voter_card_no" name="voter_card_no" value="<?php echo (!empty($alumni_candidate_details['voter_card_no']))?$alumni_candidate_details['voter_card_no']:''; ?>" placeholder="">
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="text"  class="form-control preview_input" id="passport_no" name="passport_no" value="<?php echo (!empty($alumni_candidate_details['passport_no']))?$alumni_candidate_details['passport_no']:''; ?>" placeholder="">
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input class="form-control preview_input" name="parents_name" value="<?php echo set_value('contact_no'); ?>" id="parents_name">
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              <label class="control-label">Parents E-Mail </label>
                              <input type="email" placeholder="eg.: examples@email.com" class="form-control preview_input" id="parents_email" name="parents_email" value="<?php echo set_value('email'); ?>" >
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              <label class="control-label">Parents Contact Number (Mobile) </label>
                              <input class="form-control preview_input" name="parents_contact_no" value="<?php echo set_value('contact_no'); ?>" placeholder="(00) 00000-00000" data-input-mask="(99) 99999-99999"  id="parents_contact_no">
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              <label class="control-label">Relationship </label>
                              <input type="email" class="form-control preview_input" id="relationship" name="relationship" value="<?php echo set_value('email'); ?>" >
                            </div>
                          </div>
                        </div>
                      ...
                      <?php if(!empty($survey_display_arr[2]))
                      {
                        //pr($survey_display_arr[2]);

                        for($i=0 ; $i < count($survey_display_arr[2]) ; $i++)
                        {
                           //pr($survey_display_arr[2][$i]);
                      ?>
                        <button id="<?php echo $survey_display_arr[2][$i]['combination_id'] ;?>" class="btn btn-primary survey_btn" data-toggle="modal" data-target="#survey_modal2"><?php echo $survey_display_arr[2][$i]['combination_link'] ;?></button>
                        <input type="hidden" id="combination_id" value="<?php echo $survey_display_arr[2][$i]['combination_id'] ;?>">
                        <section class="at-login-form">
                          <!-- MODAL survey -->
                          <div class="modal fade" id="survey_modal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                <div class="modal-header modal-header-primary">
                                  <h2>Survey <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button></h2>
                                </div>
                                <div class="modal-body">
                                  <div id="box">
                                    <form id="survey-frm2" role="form">
                                      
                                      <div id="survey-tab-inside" class="tab-pane survey-tab-inside"> 
                                ...
                                <div class="modal-footer">
                                  <button id="<?php echo $survey_display_arr[2][$i]['combination_id'] ;?>" data-toggle="modal" data-dismiss="modal" data-id="" class="btn btn-success survey_submit_cls">Submit </button>
                                </div>
                              </div>
                            </div>
                          </div>
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        <label class="control-label">Year of Passing <span class="required" aria-required="true">*</span></label>
                         <input  id="year_of_passing_ssc" name="year_of_passing_ssc" value="<?php echo (!empty($single_qualification['end_date']))?date('Y',strtotime($single_qualification['end_date'])):''; //echo (!empty(set_value('year_of_passing_ssc')))?set_value('year_of_passing_ssc'):$single_qualification['end_date']; ?>" placeholder="____" class="form-control valid preview_input">                        
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label class="control-label">Year of Passing <span class="required" aria-required="true">*</span></label>
                        <input data-input-mask="9999" id="year_of_passing_hsc" name="year_of_passing_hsc" value="<?php echo (!empty($single_qualification['end_date']))?date('Y',  strtotime($single_qualification['end_date'])):''; //echo (!empty(set_value('year_of_passing_hsc')))?set_value('year_of_passing_hsc'):$single_qualification['end_date']; ?>" placeholder="____" class="form-control valid preview_input" >                        
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                    ...
                    <div id="passed_data_ug">
                        <div id="passed_data_ug_year" class="">
                            <div class="col-md-3">
                              <div class="form-group">
                                <label class="control-label">Year of Passing <span class="required" aria-required="true">*</span></label>
                                 <input id="date"  data-input-mask="9999" name="year_of_passing_ug" value="<?php echo (!empty($single_qualification['end_date']))?date('Y',strtotime($single_qualification['end_date'])):''; //echo (!empty(set_value('year_of_passing_ug')))?set_value('year_of_passing_ug'):$single_qualification['end_date']; ?>" placeholder="____" class="form-control valid preview_input ">                        
                              </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-3">
                              <div class="form-group">
                                <label class="control-label">Year of Passing</label>
                                 <input id="date"  data-input-mask="9999" name="year_of_passing_pg" value="<?php echo (!empty($single_qualification['end_date']))?date('Y',strtotime($single_qualification['end_date'])):''; //echo (!empty(set_value('year_of_passing_pg')))?set_value('year_of_passing_pg'):$single_qualification['end_date']; ?>" placeholder="____" class="form-control valid preview_input" >                        
                              </div>
                            </div>
                          </div>
            ...
            ?>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              <label class="control-label">Name of the School <span class="required" aria-required="true">*</span></label>
                              <input type="text" class="form-control preview_input" id="name_of_the_school_ssc" name="name_of_the_school_ssc" value="<?php echo (!empty($alumni_candidate_details['name_of_the_school_ssc']))?$alumni_candidate_details['name_of_the_school_ssc']:''; ?>">
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              <label class="control-label">Name of the Board <span class="required" aria-required="true">*</span></label>
                              <input type="text" class="form-control preview_input" id="name_of_the_board_ssc" name="name_of_the_board_ssc" value="<?php echo (!empty($alumni_candidate_details['name_of_the_board_ssc']))?$alumni_candidate_details['name_of_the_board_ssc']:''; ?>">
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              <label class="control-label">Year of Passing <span class="required" aria-required="true">*</span></label>
                              <input  id="year_of_passing_ssc" name="year_of_passing_ssc" value="<?php echo (!empty($alumni_candidate_details['year_of_passing_ssc']))?date('Y',strtotime($alumni_candidate_details['year_of_passing_ssc'])):''; ?>" placeholder="____" class="form-control valid preview_input ">
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              <label class="control-label">Percentage <span class="required" aria-required="true">*</span></label>
                              <input type="text" class="form-control preview_input" id="percentage_ssc" name="percentage_ssc" value="<?php echo (!empty($alumni_candidate_details['percentage_ssc']))?$alumni_candidate_details['percentage_ssc']:''; ?>">
                            </div>
                          </div>
                        </div>
                        <hr>
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group">
                              <label class="control-label">Group / Major <span class="required" aria-required="true">*</span></label>
                              <input type="text" class="form-control preview_input" id="group_major_hsc" name="group_major_hsc" value="<?php echo (!empty($alumni_candidate_details['specialization']))?$alumni_candidate_details['specialization']:''; ?>">
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              <label class="control-label">Name of the School <span class="required" aria-required="true">*</span></label>
                              <input type="text" class="form-control preview_input" id="name_of_the_school_hsc" name="name_of_the_school_hsc" value="<?php echo (!empty($alumni_candidate_details['name_of_the_school_hsc']))?$alumni_candidate_details['name_of_the_school_hsc']:''; ?>">
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              <label class="control-label">Name of the Board <span class="required" aria-required="true">*</span></label>
                              <input type="text" class="form-control preview_input" id="name_of_the_board_hsc" name="name_of_the_board_hsc" value="<?php echo (!empty($alumni_candidate_details['name_of_the_board_hsc']))?$alumni_candidate_details['name_of_the_board_hsc']:''; ?>">
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              <label class="control-label">Year of Passing <span class="required" aria-required="true">*</span></label>
                              <input data-input-mask="9999" id="year_of_passing_hsc" name="year_of_passing_hsc" value="<?php echo (!empty($alumni_candidate_details['year_of_passing_hsc']))?date('Y',strtotime($alumni_candidate_details['year_of_passing_hsc'])):''; ?>" placeholder="____" class="form-control valid preview_input" >
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              <label class="control-label">Percentage <span class="required" aria-required="true">*</span></label>
                              <input type="text" class="form-control preview_input" id="percentage_hsc" name="percentage_hsc" value="<?php echo (!empty($alumni_candidate_details['percentage_hsc']))?$alumni_candidate_details['percentage_hsc']:''; ?>">
                            </div>
                          </div>
                        </div>
                        <hr>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                              <label class="control-label">Specialization <span class="required" aria-required="true">*</span></label>
                              <input type="text" class="form-control preview_input" id="specialization_ug" name="specialization_ug" value="<?php echo (!empty($alumni_candidate_details['specialization_ug']))?$alumni_candidate_details['specialization_ug']:''; ?>">
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              <label class="control-label">Name of the College <span class="required" aria-required="true">*</span></label>
                              <input type="text" class="form-control preview_input" id="name_of_the_college_ug" name="name_of_the_college_ug" value="<?php echo (!empty($alumni_candidate_details['name_of_the_college_ug']))?$alumni_candidate_details['name_of_the_college_ug']:''; ?>">
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              <label class="control-label">Name of the University <span class="required" aria-required="true">*</span></label>
                              <input type="text" class="form-control preview_input" id="name_of_the_university_ug" name="name_of_the_university_ug" value="<?php echo (!empty($alumni_candidate_details['name_of_the_university_ug']))?$alumni_candidate_details['name_of_the_university_ug']:''; ?>">
                            </div>
                          </div>
                        </div>
                          ...
                          <div id="passed_data_ug" class="hide">
                            <div id="passed_data_pg_year" class="">
                              <div class="col-md-3">
                                <div class="form-group">
                                  <label class="control-label">Year of Passing <span class="required" aria-required="true">*</span></label>
                                  <input id="year_of_passing_ug"  data-input-mask="9999" name="year_of_passing_ug" value="<?php echo (!empty($alumni_candidate_details['year_of_passing_ug']))?date('Y',strtotime($alumni_candidate_details['year_of_passing_ug'])):''; ?>" placeholder="____" class="form-control valid preview_input">
                                </div>
                              </div>
                            </div>
                            <div id="passed_data_ug_percentage" class="">
                              <div class="col-md-3">
                                <div class="form-group">
                                  <label class="control-label">Percentage <span class="required" aria-required="true">*</span></label>
                                  <input type="text" class="form-control preview_input" id="percentage_ug" name="percentage_ug" value="<?php echo (!empty($alumni_candidate_details['percentage_ug']))?$alumni_candidate_details['percentage_ug']:''; ?>" >
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="row">
                          ...
                          <div class="hide" id="degree_diploma_pg_others_div">
                            <div class="col-md-3">
                              <div class="form-group">
                                <label class="control-label">Specify</label>
                                <input type="text" class="form-control preview_input" id="degree_diploma_pg_others" name="degree_diploma_pg_others" value="<?php echo (!empty($alumni_candidate_details['first_name']))?$alumni_candidate_details['first_name']:''; ?>" >
                              </div>
                            </div>
                          </div>
                          <div class="col-md-3">
                            <div class="form-group">
                              <label class="control-label">Specialization</label>
                              <input type="text" class="form-control preview_input" id="specialization_pg" name="specialization_pg" value="<?php //echo (!empty($alumni_candidate_details['specialization_pg']))?$alumni_candidate_details['specialization_pg']:''; ?>" >
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              <label class="control-label">Name of the College</label>
                              <input type="text" class="form-control preview_input" id="name_of_the_college_pg" name="name_of_the_college_pg" value="<?php //echo (!empty($alumni_candidate_details['name_of_the_college_pg']))?$alumni_candidate_details['name_of_the_college_pg']:''; ?>" >
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              <label class="control-label">Name of the University </label>
                              <input type="text" class="form-control preview_input" id="name_of_the_university_pg" name="name_of_the_university_pg" value="<?php //echo (!empty($alumni_candidate_details['name_of_the_university_pg']))?$alumni_candidate_details['name_of_the_university_pg']:''; ?>" >
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          ...
                          <div id="passed_data_pg" class="hide">
                            <div id="passed_data_pg_year" class="">
                              <div class="col-md-3">
                                <div class="form-group">
                                  <label class="control-label">Year of Passing</label>
                                  <input id="year_of_passing_pg"  data-input-mask="9999" name="year_of_passing_pg" value="<?php //echo (!empty($alumni_candidate_details['year_of_passing_pg']))?$alumni_candidate_details['year_of_passing_pg']:''; ?>" placeholder="____" class="form-control valid preview_input" >
                                </div>
                              </div>
                            </div>
                            <div id="passed_data_pg_percentage" class="">
                              <div class="col-md-3">
                                <div class="form-group">
                                  <label class="control-label">Percentage</label>
                                  <input type="text" class="form-control preview_input" id="percentage_pg" name="percentage_pg" value="<?php //echo (!empty($alumni_candidate_details['percentage_pg']))?$alumni_candidate_details['percentage_pg']:''; ?>" >
                                </div>
                              </div>
                            </div>
                          </div>
              ...
              <?php } ?>
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group">
                                <?php
                                if(!empty($alumni_candidate_details['professional_qualification']))
                                {
                                    $professional_qualification_arr = json_decode($alumni_candidate_details['professional_qualification'],TRUE);
                                }?>
                              <div class="checkbox-custom checkbox-default">
                                <input type="checkbox"  class="professional_qualification_cls" name="professional_qualification_check[]" id="qualification1"
                                       value="CA"  <?php if(!empty($professional_qualification_arr) && in_array('CA',$professional_qualification_arr)) echo "checked='checked'"; //echo ($alumni_candidate_details['professional_qualification'] == "CA" ? 'selected="selected"': ''); ?>>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <?php
                                if(!empty($alumni_candidate_details['competitive_exams']))
                                {
                                    $competitive_exams_arr = json_decode($alumni_candidate_details['competitive_exams'],TRUE);
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            ...
                            <textarea class="form-control preview_input" rows="3" id="academic_achievement" name="academic_achievement" 
                                      ><?php echo (!empty($alumni_candidate_details['academic_or_cocurricular_achievements']))?$alumni_candidate_details['academic_or_cocurricular_achievements']:''; ?>
                            </textarea>
                          </div>
                        </div>
                        <div class="row">
                      ...
                      <?php if(!empty($survey_display_arr[3]))
                      {
                        for($i=0 ; $i < count($survey_display_arr[3]) ; $i++)
                        {
                           //pr($survey_display_arr[3][$i]);
                      ?>
                        <button id="<?php echo $survey_display_arr[3][$i]['combination_id'] ;?>" class="btn btn-primary survey_btn" data-toggle="modal" data-target="#survey_modal3"><?php echo $survey_display_arr[3][$i]['combination_link'] ;?></button>
                        <section class="at-login-form">
                          <!-- MODAL survey -->
                          <div class="modal fade" id="survey_modal3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                <div class="modal-header modal-header-primary">
                                  <h2>Survey <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button></h2>
                                ...
                                <div class="modal-footer">
                                  <button id="<?php echo $survey_display_arr[3][$i]['combination_id'] ;?>" data-question="" class="btn btn-success survey_submit_cls">Submit </button>
                                </div>
                              </div>
                            </div>
                          </div>
                      ...
                      <div id="professional-experience" class="tab-pane">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control preview_input" id="total_exp_years" name="total_exp_years" 
                                     value="<?php echo (!empty($alumni_candidate_details['professional_experience']))?intval($alumni_candidate_details['professional_experience']):0;?> " 
                                     placeholder="">
                            </div>
                          </div>
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control preview_input" id="total_exp_months" name="total_exp_months" 
                                     value="<?php echo (!empty($alumni_candidate_details['professional_experience']))?($alumni_candidate_details['professional_experience'] - intval($alumni_candidate_details['professional_experience'])):0;?> " placeholder="">
                              <br>
                            </div>
                          </div>
                          <div class="col-md-12">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                              ...
                              <input type="text"  class="form-control preview_input datepicker" id="start_from_1" name="start_from_1" data-date-end-date="0d" data-plugin-datepicker="" value="<?php echo (!empty($single_professional_experience['start_from']))?$single_professional_experience['start_from']:''; ?>"
                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                              ...
                              <input type="text"  class="form-control preview_input datepicker" id="start_to_1" name="start_to_1" data-date-end-date="0d" data-plugin-datepicker="" value="<?php echo (!empty($single_professional_experience['start_to']))?$single_professional_experience['start_to']:''; ?>" 
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                              <label class="control-label">From </label>
                              <input type="text"  class="form-control preview_input datepicker" id="start_from_1" name="start_from_1" data-date-end-date="0d" data-plugin-datepicker="" value="<?php echo set_value('start_from_1'); ?>" readonly="readonly"
                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                              <label class="control-label">To</label>
                              <input type="text"  class="form-control preview_input datepicker" id="start_to_1" name="start_to_1" data-date-end-date="0d" data-plugin-datepicker="" value="<?php echo set_value('start_to_1'); ?>"  readonly="readonly"
                               placeholder="__/__/____"   >
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                              <input type="text"  class="form-control preview_input datepicker" id="start_from_2" name="start_from_2" data-date-end-date="0d" data-plugin-datepicker="" readonly="readonly"
                                     value="<?php echo set_value('start_from_2'); ?>" data-input-mask="99/99/9999" placeholder="__/__/____"  >
                            </div>
                          </div>
                          <div class="col-md-3">
                            <div class="form-group">
                              <input type="text"  class="form-control preview_input datepicker" id="start_to_2" name="start_to_2" data-date-end-date="0d" data-plugin-datepicker="" readonly="readonly"
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                              <input type="text"  class="form-control preview_input datepicker" id="start_from_3" name="start_from_3" data-date-end-date="0d"
                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                              <input type="text"  class="form-control preview_input datepicker" id="start_to_3" name="start_to_3" data-date-end-date="0d" data-plugin-datepicker="" 
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-12">
                            ...
                            <textarea class="form-control preview_input" rows="3"  id="professional_achievements" name="professional_achievements" 
                                      ><?php echo (!empty($alumni_candidate_details['professional_achievements']))?$alumni_candidate_details['professional_achievements']:'';?></textarea>
                          </div>
                        </div>
                      </div>
                      <?php if(!empty($survey_display_arr[4]))
                      {
                        for($i=0 ; $i < count($survey_display_arr[4]) ; $i++)
                        {
                           //pr($survey_display_arr[1][$i]);
                      ?>
                        <button id="<?php echo $survey_display_arr[4][$i]['combination_id'] ;?>" class="btn btn-primary survey_btn" data-toggle="modal" data-target="#survey_modal4"><?php echo $survey_display_arr[4][$i]['combination_link'] ;?></button>
                        <section class="at-login-form">
                          <!-- MODAL survey -->
                          <div class="modal fade" id="survey_modal4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                <div class="modal-header modal-header-primary">
                                  <h2>Survey <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button></h2>
                                ...
                                <div class="modal-footer">
                                  <button id="<?php echo $survey_display_arr[4][$i]['combination_id'] ;?>" class="btn btn-success survey_submit_cls">Submit </button>
                                </div>
                              </div>
                            </div>
                          </div>
                  ...
                  <div class="tab-pane" role="tabpanel" id="verify_statement">
                    <form role="form">
                          ...
                          <section class="panel panel-primary">
                            <div class="panel-body">
                              ...
                              <table class="table table-striped">
                                ...
                                <tr>
                                  <td><div id="first_name_data"> <?php echo ucfirst(!empty($alumni_candidate_details['first_name']))?$alumni_candidate_details['first_name']:''; ?> </div></td>
                                  <td><div id="middle_name_data"> <?php echo (!empty($alumni_candidate_details['middle_name']))?$alumni_candidate_details['middle_name']:'';?> </div></td>
                                  <td><div id="last_name_data" > <?php echo (!empty($alumni_candidate_details['last_name']))?$alumni_candidate_details['last_name']:''; ?> </div></td>
                                  <td><div id="date_of_birth_data" > <?php echo (!empty($alumni_candidate_details['date_of_birth']))?date('d/m/Y',  strtotime($alumni_candidate_details['date_of_birth'])):'';?> </div></td>
                                </tr>
                                <tr>
                                  <td><b>Sex</b></td>
                                ...
                                <tr>
                                  <td><div id="gender_data"> <?php echo (!empty($alumni_candidate_details['sex']))?$alumni_candidate_details['sex']:''; ?>  </div></td>
                                  <td><div id="marital_status_data"> <?php echo (!empty($alumni_candidate_details['marrital_status']))?$alumni_candidate_details['marrital_status']:''; ?>  </div></td>
                                  <td><div id="phone_data" > <?php echo (!empty($alumni_candidate_details['contact_number']))?$alumni_candidate_details['contact_number']:''; ?> </div></td>
                                  <td><div id="email_data" > <?php echo (!empty($alumni_candidate_details['email_id']))?$alumni_candidate_details['email_id']:''; ?> </div></td>
                                </tr>
                            ...
                            ?>
                                <tr>
                                    <td><b>Interview Preferred Location</b></td>
                                </tr>
                                <tr>
                                    <td><div id="preferred_location_display"><?php echo (!empty($alumni_candidate_details['interview_preferred_location']))?getVenueById($alumni_candidate_details['interview_preferred_location']):''; ?> </div>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td><div id="pan_card_no_data"> <?php echo (!empty($alumni_candidate_details['pan_card_no']))?$alumni_candidate_details['pan_card_no']:''; ?> </div></td>
                                  <td><div id="adhar_card_no_data"> <?php echo (!empty($alumni_candidate_details['adhar_card_no']))?$alumni_candidate_details['adhar_card_no']:'';?> </div></td>
                                  <td><div id="voter_card_no_data" > <?php echo (!empty($alumni_candidate_details['voter_card_no']))?$alumni_candidate_details['voter_card_no']:'';?> </div></td>
                                  <td><div id="passport_no_data" > <?php  echo (!empty($alumni_candidate_details['passport_no']))?$alumni_candidate_details['passport_no']:''; ?> </div></td>
                                </tr>
                              </table>
                              <hr>
                            ...
                            ?>
                              ...
                              <table class="table table-striped" >
                                <tr>
                                  <th> Professional Total Experience </th>
                                </tr>
                                <tr>
                                  <td>
                                      <div id="professional_total_experience" >
                              ...
                              <table class="table table-striped" id="prof_experience_tbl">
                                ...
                                <tr>
                                  <td><div id="organization_data" ><?php echo (!empty($alumni_candidate_details['professional_achievements']))?$alumni_candidate_details['professional_achievements']:'';?> </div></td>
                                </tr>
                              </table>
                            </div>
                          </section>
                      ...
                      <?php if(!empty($survey_display_arr[5]))
                      {
                        for($i=0 ; $i < count($survey_display_arr[5]) ; $i++)
                        {
                           //pr($survey_display_arr[1][$i]);
                      ?>
                        <button id="<?php echo $survey_display_arr[5][$i]['combination_id'] ;?>" class="btn btn-primary survey_btn" data-toggle="modal" data-target="#survey_modal5"><?php echo $survey_display_arr[5][$i]['combination_link'] ;?></button>
                        <section class="at-login-form">
                          <!-- MODAL survey -->
                          <div class="modal fade" id="survey_modal5" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                <div class="modal-header modal-header-primary">
                                  <h2>Survey <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button></h2>
                                ...
                                <div class="modal-footer">
                                  <button id="<?php echo $survey_display_arr[5][$i]['combination_id'] ;?>" class="btn btn-success survey_submit_cls">Submit </button>
                                </div>
                              </div>
                            </div>
                          </div>
                ...
                <!-- MODAL LOGIN -->
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                      <div class="row">
                        <input type="radio" id="online_payment" name="payment_type" class="payment" value="online">
                        <label>Online</label>
                      </div >
                    </div>
                    <div class="col-md-12">
                      <div class="row">
                        <input type="radio" id="offline_payment" name="payment_type" class="payment" value="offline">
                        <label>Offline</label>
                      </div>
                    </div>
                  </div>
                      ...
                      <div class="panel-footer">
                        <ul class="pager">
                          ...
                          <li class="next">
                            <button class="btn  btn-primary pull-right round-button" id="next_payment_declaration" data-login="1">Next <i class="fa fa-angle-right"></i></button>
                          </li>
                        </ul>
                      </div>
                    </form>
