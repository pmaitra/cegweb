                    ...
                    <form class="" id="user-registraiton-frm"  enctype="multipart/form-data" action="<?php //echo BASEURL;?>usersubmission" method="post" role="form">
                      <div  class="">
                        ...
                        <div class="row">
                          <div class="col-md-4">
                            <div class="form-group">
                              <label class="control-label">First Name 
                                  <?php echo (!empty($registration_local_language_list['first_name']))?'/ '.$registration_local_language_list['first_name']:'';?>
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <?php echo (!empty($registration_local_language_list['middle_name']))?'/ '.$registration_local_language_list['middle_name']:'';?></label>
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              <label class="control-label">Last Name 
                                  <?php echo (!empty($registration_local_language_list['last_name']))?'/ '.$registration_local_language_list['last_name']:'';?>
                                  <span class="required" aria-required="true">*</span></label>
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              <label class="control-label">Date Of Birth 
                                  <?php echo (!empty($registration_local_language_list['date_of_birth']))?'/ '.$registration_local_language_list['date_of_birth']:'';?>
                                  <span class="required" aria-required="true">*</span></label>
                              <input name="date_of_birth" id="date_of_birth" type="text" data-plugin-datepicker=""   data-date-end-date="-2d" readonly="readonly" placeholder="Select date" class="form-control readonly datepicker">
                            </div>
                          </div>
                          <div class="col-md-4">
                            <div class="form-group">
                              <label class="control-label">
                                  Sex <?php echo (!empty($registration_local_language_list['sex']))?'/ '.$registration_local_language_list['sex']:'';?><span class="required" aria-required="true">*</span></label>
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                              <label class="control-label">Marital Status 
                                  <?php echo (!empty($registration_local_language_list['marital_status']))?'/ '.$registration_local_language_list['marital_status']:'';?><span class="required" aria-required="true">*</span></label>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              <label class="control-label">Contact Number (Mobile)  
                                  <?php echo (!empty($registration_local_language_list['contact_number']))?'/ '.$registration_local_language_list['contact_number']:'';?>
                                  <span class="required" aria-required="true">*</span></label>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              <label class="control-label">E-Mail  <?php echo (!empty($registration_local_language_list['email']))?'/ '.$registration_local_language_list['email']:'';?>
                                  <span class="required" aria-required="true">*</span></label>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              <label class="control-label">Street Address 
                                   <?php echo (!empty($registration_local_language_list['address_1']))?'/ '.$registration_local_language_list['address_1']:'';?>
                                  <span class="required" aria-required="true">*</span></label>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              <label class="control-label"> 
                                  Address Line 2 <?php echo (!empty($registration_local_language_list['address_2']))?'/ '.$registration_local_language_list['address_2']:'';?></label>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              <label class="control-label">  
                                  City <?php echo (!empty($registration_local_language_list['city']))?'/ '.$registration_local_language_list['city']:'';?> <span class="required" aria-required="true">*</span></label>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              <label class="control-label">  
                                  State / Province / Region <?php echo (!empty($registration_local_language_list['state']))?'/ '.$registration_local_language_list['state']:'';?><span class="required" aria-required="true">*</span></label>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              <label class="control-label"> 
                                  Postal / Zip Code  <?php echo (!empty($registration_local_language_list['zip_code']))?'/ '.$registration_local_language_list['zip_code']:'';?><span class="required" aria-required="true">*</span></label>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              <label class="control-label">  
                                  Country <?php echo (!empty($registration_local_language_list['country']))?'/ '.$registration_local_language_list['country']:'';?><span class="required" aria-required="true">*</span></label>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              <label class="control-label">  
                                  Upload Photograph <?php echo (!empty($registration_local_language_list['profile_picture']))?'/ '.$registration_local_language_list['profile_picture']:'';?>(Max size 200 KB)</label>
                          ...
                          <div class="col-md-6">
                            ...
                            <?php if(!empty($venue_list)){
                              ?>    
                                ...
                                <select id="interview_preferred_location" name="venue" class="form-control preview_select" data-previewid="country_data">
                                  <option id="" value="0" >Select</option>
                                    <?php foreach ($venue_list as $single_venue) { ?>
                                      <option id="<?php echo $single_venue['id'] ?>" value="<?php echo $single_venue['id'] ?>" ><?php  echo $single_venue['city'] ?></option>
                                    <?php } ?>
                                </select>   
                            <?php  }  else {  ?>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="file" class="form-control file_upload_input" id="pan_card" name="pan_card" value="<?php //echo set_value('zip_code'); ?>" placeholder="">
                              <input  type="hidden" class="" value="" id="pan_card_input">
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="file" class="form-control file_upload_input" id="adhar_card" name="adhar_card" value="<?php //echo set_value('zip_code'); ?>" placeholder="">
                              <input type="hidden" class="" value="" id="adhar_card_input">
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="file" class="form-control file_upload_input" id="voter_card" name="voter_card" value="<?php //echo set_value('zip_code'); ?>" placeholder="">
                              <input type="hidden" class="" value="" id="voter_card_input">
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="file" class="form-control file_upload_input" id="passport" name="passport" value="<?php //echo set_value('zip_code'); ?>" placeholder="">
                              <input type="hidden" class="" value="" id="passport_input">
                            </div>
                          </div>
                        </div>
                      ...
                      <?php //pr($survey_display_arr);
                      if(!empty($survey_display_arr[2]))
                      {
                      ...
                      ?>
                        ...
                        <button id="<?php echo $survey_display_arr[2]['combination_id'] ;?>" class="btn btn-primary survey_btn" data-toggle="modal" data-target="#survey_modal2"><?php echo ucfirst($survey_display_arr[2]['combination_name']) ;?></button>
                        <input type="hidden" id="combination_id" value="<?php echo $survey_display_arr[2]['combination_id'] ;?>">
                            ...
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                <div class="modal-header modal-header-primary">
                                  <h2><?php echo $survey_display_arr[2]['combination_name'] ;?> <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button></h2>
                                </div>
                                ...
                                <div class="modal-footer">
                                  <button id="<?php echo $survey_display_arr[2]['combination_id'] ;?>" data-toggle="modal" data-dismiss="modal" data-id="" class="btn btn-success survey_submit_cls">Submit </button>
                                </div>
                              </div>
                            </div>
                          </div>
                  ...
                  <div class="tab-pane" role="tabpanel" id="academic_qualification">
                    <form id="accademics-update-frm"   action="<?php echo BASEURL;?>accademicssubmission" method="post" role="form">
                      ...
                      ?>
                        ...
                        <button id="<?php echo $survey_display_arr[3]['combination_id'] ;?>" class="btn btn-primary survey_btn" data-toggle="modal" data-target="#survey_modal3"><?php echo ucfirst($survey_display_arr[3]['combination_name']) ;?></button>
                        <section class="at-login-form">
                          <!-- MODAL survey -->
                          <div class="modal fade" id="survey_modal3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                <div class="modal-header modal-header-primary">
                                  <h2><?php echo $survey_display_arr[3]['combination_name'] ;?> <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button></h2>
                                </div>
                                <div class="modal-body">
                                  <div id="box">
                                ...
                                <div class="modal-footer">
                                  <button id="<?php echo $survey_display_arr[3]['combination_id'] ;?>" data-toggle="modal" data-dismiss="modal" data-question="" class="btn btn-success survey_submit_cls">Submit </button>
                                </div>
                              </div>
                            </div>
                          </div>
                    ...
                    <form id="prof-experience-update-frm" action="#" method="post" role="form">
                      <div id="professional-experience" class="tab-pane">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-2">
                            <div class="form-group">
                              ...
                              <input type="text"  class="form-control preview_input datepicker" id="start_from_1" name="start_from_1" data-date-end-date="0d"
                                     data-plugin-datepicker="" value="<?php echo set_value('start_from_1'); ?>" readonly="readonly" 
                          ...
                          <div class="col-md-2">
                            <div class="form-group">
                              ...
                              <input type="text"  class="form-control preview_input datepicker" id="start_to_1" name="start_to_1" data-date-end-date="0d"
                                     data-plugin-datepicker="" value="<?php echo set_value('start_to_1'); ?>" readonly="readonly" 
                                      placeholder="__/__/____">
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-2">
                            <div class="form-group">
                              <input type="text"  class="form-control preview_input datepicker" data-date-end-date="0d" id="start_from_2" readonly="readonly" name="start_from_2" value="<?php echo set_value('start_from_2'); ?>"
                                placeholder="__/__/____" data-plugin-datepicker="" >
                            </div>
                          </div>
                          <div class="col-md-2">
                            <div class="form-group">
                              <input type="text"  class="form-control preview_input datepicker" data-date-end-date="0d" id="start_to_2" readonly="readonly" name="start_to_2" value="<?php echo set_value('start_to_2'); ?>" 
                               placeholder="__/__/____" data-plugin-datepicker="" >
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-2">
                            <div class="form-group">
                              <input type="text"  class="form-control preview_input datepicker" data-date-end-date="0d" id="start_from_3" readonly="readonly" name="start_from_3" value="<?php echo set_value('start_from_3'); ?>"
                                placeholder="__/__/____" data-plugin-datepicker="" >
                            </div>
                          </div>
                          <div class="col-md-2">
                            <div class="form-group">
                              <input type="text"  class="form-control preview_input datepicker" data-date-end-date="0d" id="start_to_3" readonly="readonly" name="start_to_3" value="<?php echo set_value('start_to_3'); ?>" 
                               placeholder="__/__/____" data-plugin-datepicker="" >
                            </div>
                          </div>
                        </div>
                      ...
                      ?>
                        ...
                        <button id="<?php echo $survey_display_arr[4]['combination_id'] ;?>" class="btn btn-primary survey_btn" data-toggle="modal" data-target="#survey_modal4"><?php echo ucfirst($survey_display_arr[4]['combination_name']) ;?></button>
                        <section class="at-login-form">
                          <!-- MODAL survey -->
                          <div class="modal fade" id="survey_modal4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                <div class="modal-header modal-header-primary">
                                  <h2><?php echo $survey_display_arr[4]['combination_name'] ;?> <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button></h2>
                                </div>
                                <div class="modal-body">
                                  <div id="box">
                                ...
                                <div class="modal-footer">
                                  <button id="<?php echo $survey_display_arr[4]['combination_id'] ;?>"  data-toggle="modal" data-dismiss="modal" class="btn btn-success survey_submit_cls">Submit </button>
                                </div>
                              </div>
                            </div>
                          </div>
                    ...
                    <form role="form">
                          ...
                          <section class="panel panel-primary">
                            <div class="panel-body">
                              ...
                              <table class="table table-striped">
                                ...
                                <tr>
                                    <td id=""><b>Interview Preferred Location</b></td>
                                </tr>
                                <tr>
                                    <td><div id="preferred_location_display"></div></td>
                                </tr>
                                <tr>
                                <tr>
                      ...
                      <?php if(!empty($survey_display_arr[5]))
                      {
                        for($i=0 ; $i < count($survey_display_arr[5]) ; $i++)
                        {
                           //pr($survey_display_arr[1][$i]);
                      ?>
                        <button id="<?php echo $survey_display_arr[5][$i]['combination_id'] ;?>" class="btn btn-primary survey_btn" data-toggle="modal" data-target="#survey_modal5"><?php echo ucfirst($survey_display_arr[5][$i]['combination_name']) ;?></button>
                        <section class="at-login-form">
                          <!-- MODAL survey -->
                          <div class="modal fade" id="survey_modal5" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                <div class="modal-header modal-header-primary">
                                  <h2><?php echo $survey_display_arr[5][$i]['combination_name'] ;?> <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button></h2>
                                </div>
                                <div class="modal-body">
                                  <div id="box">
                                ...
                                <div class="modal-footer">
                                  <button id="<?php echo $survey_display_arr[5][$i]['combination_id'] ;?>" data-toggle="modal" data-dismiss="modal" class="btn btn-success survey_submit_cls">Submit </button>
                                </div>
                              </div>
                            </div>
                          </div>
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="panel-footer">
                        <ul class="pager">
                          ...
                          <li class="next">
                            <button class="btn btn-primary pull-right round-button" id="next_payment_declaration" data-login="0">Next <i class="fa fa-angle-right"></i></button>
                          </li>
                        </ul>
                      </div>
                    </form>
