...
class Dashboard extends CI_Controller {
    ...
    function index()
    {
        ...
        $candidate_details = fetch_single_row('candidate_details', array('id','first_name','middle_name',
            ...
            'interview_ready_flag','interview_schedule_flag','scrutiny_flag','selected_flag','pan_card_no','adhar_card_no','voter_card_no','passport_no'),array('user_id'=>$user_id));
