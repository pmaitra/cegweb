                        ...
                        <div class="row">
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input name="date_of_birth" id="date_of_birth" type="text"  data-date-end-date="-2d" data-plugin-datepicker="" data-date-format="dd/mm/yyyy" value="<?php echo (!empty($candidate_details['date_of_birth']))?date('d/m/Y',strtotime($candidate_details['date_of_birth'])):''; ?>" readonly="readonly" class="form-control preview_input datepicker">
                            </div>
                          </div>
                          <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select id="interview_preffered_location" name="venue" class="form-control preview_select" data-previewid="country_data">
                                  <option id="" value="0" >Select</option>
                                    <?php foreach ($venue_list as $single_venue) { 
                                        if($single_venue['id'] == $candidate_details['interview_preffered_location'] )
                                        {
            ...
            ?>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              <label class="control-label">Year of Passing <span class="required" aria-required="true">*</span></label>
                              <input  id="year_of_passing_ssc" name="year_of_passing_ssc" value="<?php echo (!empty($candidate_details['year_of_passing_ssc']))?date('Y',strtotime($candidate_details['year_of_passing_ssc'])):''; ?>" placeholder="____" class="form-control valid preview_input ">
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              <label class="control-label">Year of Passing <span class="required" aria-required="true">*</span></label>
                              <input data-input-mask="9999" id="year_of_passing_hsc" name="year_of_passing_hsc" value="<?php echo (!empty($candidate_details['year_of_passing_hsc']))?date('Y',strtotime($candidate_details['year_of_passing_hsc'])):''; ?>" placeholder="____" class="form-control valid preview_input" >
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                          ...
                          <div id="passed_data_ug" class="hide">
                            <div id="passed_data_pg_year" class="">
                              <div class="col-md-3">
                                <div class="form-group">
                                  <label class="control-label">Year of Passing </label>
                                  <input id="year_of_passing_ug"  data-input-mask="9999" name="year_of_passing_ug" value="<?php echo (!empty($candidate_details['year_of_passing_ug']))?date('Y',strtotime($candidate_details['year_of_passing_ug'])):''; ?>" placeholder="____" class="form-control valid preview_input">
                                </div>
                              </div>
                            </div>
                            <div id="passed_data_ug_percentage" class="">
                    ...
                    <form id="prof-experience-update-frm" action="#" method="post" role="form">
                      <div id="professional-experience" class="tab-pane">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                              <input type="text"  class="form-control preview_input datepicker" id="start_from_3" data-date-end-date="0d" name="start_from_3" 
                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                              <input type="text"  class="form-control preview_input datepicker" id="start_to_3" data-date-end-date="0d" name="start_to_3" data-plugin-datepicker="" 
                        ...
                        <div class="row">
                          ...
                          <section class="panel panel-primary">
                            ...
                            ?>
                                ...
                                <tr>
                                    <td><div id="preferred_location_display"><?php echo (!empty($candidate_details['interview_preferred_location']))?getVenueById($candidate_details['interview_preferred_location']):''; ?> </div>
                                    </td>
                                </tr>
                                <tr>
