					...
					<div id="userbox" class="userbox">
						<a href="<?php echo BASEURL.'dashboard'?>" data-toggle="dropdown">
							<figure class="profile-picture">
								...
								<img src="<?php echo $profile_pic;?>" alt="<?php echo $this->session->userdata('loggedinusername');?>" 
                                                                     class="img-circle" 
                                                                     data-lock-picture="<?php echo $profile_pic;?>" />
							</figure>
									...
									<li>
										...
										<a href="<?php echo BASEURL.'dashboard'?>">
											<i class="fa fa-columns" aria-hidden="true"></i>
                                                                                        <span title="<?php echo $single_course['program_name'];?>">
                                                                                        <?php echo strlen($single_course['program_name']) > 20 ? substr($single_course['program_name'],0,20)."..." : $single_course['program_name'];?> </span>
										</a>
									</li>
                                                                        <?php }} ?>
									<li>
