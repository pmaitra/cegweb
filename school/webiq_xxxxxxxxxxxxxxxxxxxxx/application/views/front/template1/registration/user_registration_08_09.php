                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              <div class="checkbox-custom checkbox-default">
                                ...
                                value="CA"  <?php if(isset($candidate_details['professional_qualification'])) echo "checked='checked'"; //echo ($candidate_details['professional_qualification'] == "CA" ? 'selected="selected"': ''); ?>>
                              ...
                              <div class="checkbox-custom checkbox-default">
                                ...
                                value="CFA"  <?php if(isset($candidate_details['professional_qualification'])) echo "checked='checked'"; ?>>
                              ...
                              <div class="checkbox-custom checkbox-default">
                                ...
                                value="CS"  <?php if(isset($candidate_details['professional_qualification'])) echo "checked='checked'"; ?>>
                              ...
                              <div class="checkbox-custom checkbox-default">
                                ...
                                value="CWA"  <<?php if(isset($candidate_details['professional_qualification'])) echo "checked='checked'"; ?>>
                              ...
                              <div class="checkbox-custom checkbox-default">
                                ...
                                value="Law"  <?php if($candidate_details['professional_qualification'] == "Law") echo "checked"; ?>>
                              ...
                              <div class="checkbox-custom checkbox-default">
                                ...
                                value="Others"  <?php if(isset($candidate_details['professional_qualification'])) echo "checked='checked'"; ?>>
                            ...
                            <div class="form-group">
                              ...
                              <div class="row">
                                <div class="checkbox-custom checkbox-default col-md-1">
                                  <input type="checkbox" class="competitive_exams_cls" name="competitive_exams_check[]" id="exam1" value="GMAT" <?php if(isset($candidate_details['competitive_exams'])) echo "checked='checked'"; ?>>
                                  <label for="exam1">GMAT</label>
                                </div>
                                <div id="competitive_exams_gmat_div" class="hide col-md-2">
                                  <div class="form-group">
                                    <input type="text" class="form-control preview_input" id="professional_qualification_gmat" placeholder="Score obtained" name="professional_qualification_gmat" value="<?php if(isset($candidate_details['competitive_exams'])) echo "checked='checked'"; ?>" >
                                  </div>
                                </div>
                              </div>
                              <div class="row">
                                <div class="checkbox-custom checkbox-default col-md-1">
                                  <input type="checkbox" class="competitive_exams_cls" name="competitive_exams_check[]" id="exam2" value="CAT" <?php if(isset($candidate_details['competitive_exams'])) echo "checked='checked'"; ?>>
                              ...
                              <div class="row">
                                <div class="checkbox-custom checkbox-default col-md-1">
                                  <input type="checkbox" class="competitive_exams_cls" name="competitive_exams_check[]" id="exam3" value="XAT" <?php if(isset($candidate_details['competitive_exams'])) echo "checked='checked'"; ?>>
                              ...
                              <div class="row">
                                <div class="checkbox-custom checkbox-default col-md-1">
                                  <input type="checkbox" class="competitive_exams_cls" name="competitive_exams_check[]" id="exam4" value="CMAT" <?php if(isset($candidate_details['competitive_exams'])) echo "checked='checked'"; ?>>
                              ...
                              <div class="row">
                                <div class="checkbox-custom checkbox-default col-md-1">
                                  <input type="checkbox" class="competitive_exams_cls" name="competitive_exams_check[]" id="exam5" value="MAT" <?php if(isset($candidate_details['competitive_exams'])) echo "checked='checked'"; ?>>
                              ...
                              <div class="row">
                                <div class="checkbox-custom checkbox-default col-md-1">
                                  <input type="checkbox" class="competitive_exams_cls" name="competitive_exams_check[]" id="exam6" value="Others" <?php if(isset($candidate_details['competitive_exams'])) echo "checked='checked'"; ?>>
                    ...
                    <form id="prof-experience-update-frm" action="#" method="post" role="form">
                      <div id="professional-experience" class="tab-pane">
                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                              ...
                              <input type="text"  class="form-control preview_input datepicker" id="start_from_1" name="start_from_1" data-plugin-datepicker="" value="<?php echo (!empty($single_professional_experience['start_from']))?$single_professional_experience['start_from']:''; ?>"
                               data-input-mask="99/99/9999" placeholder="__/__/____" class="" >
                            </div>
                          </div>
                          <div class="col-md-3">
                            <div class="form-group">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                              <input type="text"  class="form-control preview_input datepicker" id="start_from_2" name="start_from_2" data-plugin-datepicker="" 
                                     value="<?php echo set_value('start_from_2'); ?>" data-input-mask="99/99/9999" placeholder="__/__/____"  >
                            </div>
                          </div>
                          <div class="col-md-3">
                            <div class="form-group">
                              <input type="text"  class="form-control preview_input datepicker" id="start_to_2" name="start_to_2" data-plugin-datepicker="" 
                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                              <input type="text"  class="form-control preview_input datepicker" id="start_to_3" name="start_to_3" data-plugin-datepicker="" 
                                     value="<?php echo set_value('start_to_3'); ?>"  placeholder="__/__/____"  >
                            </div>
                          </div>
                        </div>
                        <?php } ?>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-12">
                            ...
                            <textarea class="form-control preview_input" rows="3"  id="professional_achievements" name="professional_achievements" value="<?php echo (!empty($candidate_details['professional_achievements']))?$candidate_details['professional_achievements']:''; ?>" ></textarea>
                          </div>
                        </div>
                      </div>
                      <div class="panel-footer">
