...
class Users extends Model
{
    ...
    protected $fillable = ['first_name','last_name','middle_name','email_id','dateOfBirth','username','status','password'];
}
...
{ 
    ...
    protected $fillable = ['userId','firstName','middleName','lastName','standard','admissionDrive',
        ...
        'previousAchivement','courseCode','contactNumber','accademicSession'
        ];
}
