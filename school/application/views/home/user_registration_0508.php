                    ...
                    <form class="" id="user-registraiton-frm"  enctype="multipart/form-data" action="<?php //echo BASEURL;?>usersubmission" method="post" role="form">
                        ...
                        <div class="row">
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input id="date_of_birth" name="date_of_birth" type="text" data-plugin-datepicker="" data-date-format="dd/mm/yyyy" class="form-control datepicker">
                            </div>
                          </div>
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <div style="" class="form-group">
                                ...
                                <label class="radio-inline radio-primary preview_input padding-right-30">
                                  <input type="radio" class="preview_radio" required="required" data-previewid="gender_data" 
                                                                                                             value="Female" id="female" name="sex_is" <?php echo set_radio('sex_is', 'Female'); ?> >
                                  Female </label>
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="panel-footer">
                        <ul class="pager">
                          ...
                          <li class="next">
                            <button class="btn  btn-primary pull-right" id="btn_submit_personal_details" type="">
                    ...
                    <form id="accademics-update-frm"   action="<?php echo BASEURL;?>accademicssubmission" method="post" role="form">
                      ...
                      <div class="panel-footer">
                        <ul class="pager">
                          ...
                          <li class="next">
                            <button class="btn  btn-primary pull-right" id="btn_submit_accademic_details" type="" id="">
                            Next <i class="fa fa-angle-right"></i>
                            </button>
                    ...
                    <form id="prof-experience-update-frm" action="#" method="post" role="form">
                      <div id="professional-experience" class="tab-pane">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-2">
                            <div class="form-group">
                              ...
                              <input type="text"  class="form-control preview_input" id="start_from_1" name="start_from_1" value="<?php echo set_value('start_from_1'); ?>"
                          ...
                          <div class="col-md-2">
                            <div class="form-group">
                              ...
                              <input type="text"  class="form-control preview_input" id="start_to_1" name="start_to_1" value="<?php echo set_value('start_to_1'); ?>" 
                               data-input-mask="99/99/9999" placeholder="__/__/____" class="form-control valid"  >
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-2">
                            <div class="form-group">
                              <input type="text"  class="form-control preview_input" id="start_from_2" name="start_from_2" value="<?php echo set_value('start_from_2'); ?>"
                               data-input-mask="99/99/9999" placeholder="__/__/____" class="form-control valid" >
                            </div>
                          </div>
                          <div class="col-md-2">
                            <div class="form-group">
                              <input type="text"  class="form-control preview_input" id="start_to_2" name="start_to_2" value="<?php echo set_value('start_to_2'); ?>" 
                               data-input-mask="99/99/9999" placeholder="__/__/____" class="form-control valid"  >
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-2">
                            <div class="form-group">
                              <input type="text"  class="form-control preview_input" id="start_from_3" name="start_from_3" value="<?php echo set_value('start_from_3'); ?>"
                               data-input-mask="99/99/9999" placeholder="__/__/____" class="form-control valid" >
                            </div>
                          </div>
                          <div class="col-md-2">
                            <div class="form-group">
                              <input type="text"  class="form-control preview_input" id="start_to_3" name="start_to_3" value="<?php echo set_value('start_to_3'); ?>" 
                               data-input-mask="99/99/9999" placeholder="__/__/____" class="form-control valid"  >
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="col-md-2">
                      ...
                      <div class="panel-footer">
                        <ul class="pager">
                          ...
                          <li class="next">
                            <button class="btn  btn-primary pull-right" id="btn_submit_professional_experience">
                            Next <i class="fa fa-angle-right"></i>
                            </button>
                ...
                ?>
                  ...
                  ?>
                              ...
                              <table class="table table-striped">
                                ...
                                <tr>
                                  <td colspan="4"><div id="group_major_hsc_data" > <?php echo $single_qualification['degree'];?> </div></td>
                                </tr>
                                <tr>
                                  <td><b>Name of the School</b></td>
                                  <td><b>Name of the Board</b></td>
                    ...
                    <div class="modal fade" id="at-coupon" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h2>Coupon <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">Ã—</span></button></h2>
                      ...
                      <div class="panel-footer">
                        <ul class="pager">
                          ...
                          <li class="next">
                            <button class="btn  btn-primary pull-right" id="next_payment_declaration">Next <i class="fa fa-angle-right"></i></button>
                          </li>
                        </ul>
                      </div>
                    </form>
